    ...
    return [
      {
        title: 'YURI 2',
        text:
          'A feature rich Discord sound board with web interface and ' +
      ...
      },
      {
        title: 'ITSFRIDAY',
        text:
          'Twitter API application for spreading friday-happiness to ' +
      ...
      },
      {
        title: 'MEAUTOSD',
        text:
          'One of my older projects: A tool to shut down after Adobe ' +
          'Media Encoder queue.',
